        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border">
          ...
          <div className="mt-4 flex gap-3">
            ...
            <button
              ...
              className="border px-4 py-2 rounded-lg text-sm hover:bg-gray-50 dark:hover:bg-gray-700"
            >
              Cancel
            </button>
          </div>
      ...
      <div className="flex flex-wrap gap-3">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full pl-10 border rounded-lg px-3 py-2 text-sm dark:bg-gray-800 dark:border-gray-700"
          />
        </div>
        <select
          value={category}
            ...
            <tbody>
              {items.map((item) => (
                ...
                >
                  ...
                  <td className="p-3 text-center">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${STATUS_COLORS[item.status] || "bg-gray-100"}`}
                    >
