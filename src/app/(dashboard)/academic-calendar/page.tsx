        ...
        <div className="flex gap-2 flex-wrap">
          {calendars.map((c) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm ${activeCalendar?._id === c._id ? "bg-indigo-600 text-white" : "bg-gray-100 dark:bg-gray-700"}`}
            >
              {c.academicYear}
            </button>
          ))}
              ...
              <div className="grid grid-cols-7 gap-1">
                ...
                {Array.from({ length: daysInMonth }, (_, i) => {
                  ...
                  return (
                    <div
                      key={day}
                      className={`min-h-[80px] p-1 rounded-lg border text-xs ${isToday ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-950" : "border-gray-100 dark:border-gray-700"}`}
                    >
                      <div
