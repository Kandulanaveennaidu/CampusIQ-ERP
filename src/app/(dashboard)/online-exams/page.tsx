            ...
            <TableBody>
              {exams.length === 0 ? (
                <TableRow>
                  ...
                  >
                    <Monitor className="mx-auto h-10 w-10 mb-2 text-slate-300 dark:text-slate-600" />
                        ...
                        <div key={idx} className="p-3 border rounded-lg">
                          ...
                          <div className="mt-2 grid grid-cols-2 gap-1">
                            {q.options.map((opt, oi) => (
                              <div
                                key={oi}
                                className={`text-xs px-2 py-1 rounded ${oi === q.correctOption ? "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 font-medium" : "bg-gray-50 dark:bg-gray-800 text-slate-600 dark:text-slate-400"}`}
                              >
