    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="border px-4 py-2 rounded-lg text-sm flex items-center gap-2 hover:bg-gray-50 dark:hover:bg-gray-700"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="grid grid-cols-4 gap-2">
                {PRESET_THEMES.map((preset) => (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-gray-600">{preset.name}</p>
                  </button>
                ))}
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 border rounded-lg px-2 py-1.5 text-sm font-mono dark:bg-gray-700"
                  />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 border rounded-l-lg px-3 py-2 text-sm dark:bg-gray-700"
                  />
                  <span className="bg-gray-100 dark:bg-gray-600 border border-l-0 rounded-r-lg px-3 py-2 text-sm">
                    .campusiq.app
                  </span>
                </div>
              </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border overflow-hidden sticky top-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 p-2 space-y-1">
                  {["Dashboard", "Students", "Attendance", "Exams"].map(
                    (item, i) => (
                      <div
                        key={item}
                        className={`px-3 py-2 rounded text-xs ${i === 0 ? "text-white" : "text-gray-600"}`}
                        style={
                          i === 0
